 ...
 *
 * <p>Applied once at the earliest entry point ({@link org.beckn.catalogpublish.step.ParseStep})
 * so all downstream code reads only V2.0 field names via {@link BecknFields} constants.
 * Idempotent — V2.0 contexts pass through unchanged.
 * V1.0-only fields ({@code domain}, {@code location}) are preserved as-is.
 */
