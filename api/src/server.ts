/**
 * Entry: create Express app, mount routes and /metrics, connect Kafka, listen and graceful shutdown.
 * Exports createAppAndKafka for integration tests.
 */
...
export async function createAppAndKafka(): Promise<{
  app: Express;
  config: Config;
  logger: Logger;
