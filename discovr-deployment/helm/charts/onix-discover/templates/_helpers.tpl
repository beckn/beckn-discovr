...
{{/*
Default discover-job URL — same-release sibling service, overridable.
*/}}
{{- define "onix-discover.discoverJobUrl" -}}
{{- .Values.adapter.routing.discoverJobUrl | default (printf "http://%s-catalog-discover-job.%s.svc.cluster.local:8080/beckn" .Release.Name .Release.Namespace) -}}
{{- end }}

{{/*
Default catalog-publish-job URL — same-release sibling service, overridable.
*/}}
{{- define "onix-discover.catalogPublishJobUrl" -}}
{{- .Values.adapter.routing.catalogPublishJobUrl | default (printf "http://%s-catalog-publish-job.%s.svc.cluster.local:8080/beckn" .Release.Name .Release.Namespace) -}}
{{- end }}
